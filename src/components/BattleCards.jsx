...
const ObjectionsBattleCard = ({titleHeight, editBlueHeaderValue, blueHeaderValues, redHeaderValues, cards, deleteBattleCard, battleCardId, isEmptyAddButtonState, section, modifyBattleCardTitle, titleValue, triggerAddCardState, addCard}) => (
    ...
    <div className="battleCard">   
        ...
        <div className="cards">
            <textarea style={{height: titleHeight}} id={battleCardId} onBlur={(e) => modifyBattleCardTitle(e.target.value, battleCardId, 'objections')} onKeyPress={(e) => modifyBattleCardTitle(e.target.value, battleCardId, 'objections')} placeholder="Title of Battle Card" className="titleBattleCard">{titleValue}</textarea>        
...
const CaseStudiesBattleCard = ({titleHeight, editBlueHeaderValue, blueHeaderValues, redHeaderValues, cards, deleteBattleCard, battleCardId, isEmptyAddButtonState, section, modifyBattleCardTitle, titleValue, triggerAddCardState, addCard}) => (
    ...
    <div className="battleCard">   
        ...
        <div className="cards">
            <textarea style={{height: titleHeight}} id={battleCardId} onBlur={(e) => modifyBattleCardTitle(e.target.value, battleCardId, 'caseStudies')} onKeyPress={(e) => modifyBattleCardTitle(e.target.value, battleCardId, 'caseStudies')} placeholder="Title of Battle Card" className="titleBattleCard">{titleValue}</textarea>        
            <span className="battleCardNameHeader">
                <i className="fa fa-axe-battle"></i>
...
const CompetitorsBattleCard = ({titleHeight, editBlueHeaderValue, blueHeaderValues, redHeaderValues, cards, deleteBattleCard, battleCardId, isEmptyAddButtonState, section, modifyBattleCardTitle, titleValue, triggerAddCardState, addCard}) => (
    ...
    <div className="battleCard">   
        ...
        <div className="cards">
            <textarea style={{height: titleHeight}} id={battleCardId} onBlur={(e) => modifyBattleCardTitle(e.target.value, battleCardId, 'competitors')} onKeyPress={(e) => modifyBattleCardTitle(e.target.value, battleCardId, 'competitors')} placeholder="Title of Battle Card" className="titleBattleCard">{titleValue}</textarea>        
            <span className="battleCardNameHeader">
                <i className="fa fa-swords"></i>
